...
export const ChartBarIcon = ({ size = 24, className, ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const ChartLineIcon = ({ size = 24, className, ...props }: IconProps) => (
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className={cn("lucide lucide-line-chart", className)}
    {...props}
  >
    <path d="M3 3v18h18" />
...
export const ChartPieIcon = ({ size = 24, className, ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className={cn("lucide lucide-pie-chart", className)}
    {...props}
  >
...
export const ChartAreaIcon = ({ size = 24, className, ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    <path d="M3 3v18h18" />
    <path d="M7 12v5h10V8l-5 5-4-4Z" />
  </svg>
)

// Technology Icons
export const TypeScriptIcon = ({ size = 24, className, ...props }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    fill="currentColor"
    className={cn("typescript-icon", className)}
    {...props}
  >
...
export const CodeIcon = ({ size = 24, className, ...props }: IconProps) => (
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className={cn("lucide lucide-code", className)}
    {...props}
  >
...
export const TrendingUpIcon = ({ size = 24, className, ...props }: IconProps) => (
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className={cn("lucide lucide-trending-up", className)}
    {...props}
  >
...
export const GitHubIcon = ({ size = 24, className, ...props }: IconProps) => (
  <svg
    ...
    viewBox="0 0 24 24"
    fill="currentColor"
    className={cn("github-icon", className)}
    {...props}
  >
