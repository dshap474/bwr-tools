      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          >
            ...
            <div>
              <div className="text-white font-semibold text-lg">BWR Tools</div>
              <div className="text-gray-400 text-xs -mt-1">Research Platform</div>
            </div>
          </Link>
          ...
          {/* Mobile menu button */}
          <button className="md:hidden p-2 text-gray-400 hover:text-white transition-colors rounded-lg hover:bg-gray-800">
