        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center">
              <h3 className="text-lg font-bold text-gray-900">BWR Plots</h3>
            </div>
            <p className="mt-2 text-sm text-gray-600">
              Professional data visualization tool for creating beautiful, interactive charts and plots.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div className="flex items-center text-sm text-gray-500">
              <span>© {currentYear} BWR Plots. All rights reserved.</span>
            </div>
          ...
          {/* App Version and Stats */}
          <div className="mt-4 flex flex-col sm:flex-row sm:items-center sm:justify-between text-xs text-gray-400">
